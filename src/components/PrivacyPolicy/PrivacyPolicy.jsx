        ...
        <div className="policy-content">
          ...
          <div className="card">
            ...
            <p>
              ...
              information we collect is to acknowledge your donation. This
              includes:
            </p>
          ...
          <div className="card">
            ...
            <ul className="no-bullets">
              ...
              <li>
                We do not use your data for marketing or any other purposes
          ...
          <div className="card">
            ...
            <p>
              All collected data is securely stored in a MongoDB server hosted
              on Atlas, which uses encryption for data protection. Once our
              fundraising goal is met, we may retain the data for legal
              compliance; otherwise, it will be securely deleted.
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p>
              ...
              unless required by law. Your privacy is important to us, and we
              will only disclose your information in compliance with applicable
              legal requirements.
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p>
              We do not use cookies on our website to collect personal
          ...
          <div className="card">
            ...
            <p>
              We implement measures to protect against Cross-Site Request
              Forgery (CSRF) attacks. This includes using anti-CSRF tokens to
              ensure that all requests made to our server are genuine and
          ...
          <div className="card">
            ...
            <p>
              ...
              <a href="#contact">Contact</a> section. We are committed to
              addressing any issues related to your privacy and data protection.
            </p>
          </div>

          <div className="card">
            <h2>
              <FontAwesomeIcon icon={faSyncAlt} /> Changes to This Privacy
              Policy
            </h2>
            <p>
